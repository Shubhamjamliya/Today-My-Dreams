  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (existingReview && isEditing) {
        ...
        onCancelEdit && onCancelEdit(); // Exit edit mode after successful update
  ...
  if (!isAuthenticated || !user) {
    return (
      <div className="bg-gray-50 p-6 rounded-lg">
        ...
        <a 
          href="/login" 
          className="inline-block px-4 py-2 bg-[#FCD24C] text-white rounded-md hover:bg-[#FCD24C] transition-colors"
        >
          Login to Review
        </a>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex gap-3">
          <button
            ...
            className="px-4 py-2 bg-[#FCD24C] text-white rounded-md hover:bg-[#FCD24C] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
