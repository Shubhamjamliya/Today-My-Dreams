...
const FeaturedProducts = () => {
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this product?")) {
      try {
        setLoading(true);
        await apiService.deleteFeaturedProduct(id);
        await fetchProducts();
      } catch (error) {
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <Link
              to={`/admin/featured-products/edit/${product._id}`}
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
          <div>
            ...
            <p className="mt-1 text-sm text-gray-500">
              Manage your featured products collection
            </p>
          </div>
          <Link
            to="/admin/featured-products/edit/new"
          ...
          <>
            ...
            {filteredProducts.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  {searchTerm ? "Try adjusting your search term." : "Get started by adding a new featured product."}
                </p>
                {!searchTerm && (
                  <div className="mt-6">
                    <Link
