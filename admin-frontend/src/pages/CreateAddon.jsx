  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        toast.error(data.message || 'Failed to create add-on');
      }
    } catch (error) {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Create New Add-on</h1>
        <p className="text-gray-600 mt-2">Add a new optional item for customers</p>
      </div>
