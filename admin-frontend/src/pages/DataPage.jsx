  ...
  return (
    <div className="min-h-screen bg-white p-6">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div className="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-r from-[#FDD14E] to-[#FDD14E] rounded-full mb-4">
            <FileText size={32} className="text-white" />
          </div>
          <h1 className="text-3xl font-bold text-blue-900 mb-2">Policy Management</h1>
          <p className="text-blue-700">Manage your website's legal policies and terms</p>
        </motion.div>
          ...
          {TABS.map((tab, index) => (
            <motion.button
              ...
              className={`
                ...
                ${activeTab === tab.key
                  ? 'bg-gradient-to-r from-[#FDD14E] to-[#FDD14E] text-white shadow-lg'
        ...
        >
          {loading ? (
            <div className="p-12 text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 border-4 border-blue-200 border-t-[#FDD14E] rounded-full animate-spin mb-4"></div>
            ...
            <div className="p-8">
              <div className="mb-6">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border border-blue-200 rounded-xl focus:ring-2 focus:ring-[#FDD14E] focus:border-transparent transition-all duration-200 bg-blue-50/50"
                />
              </div>
              ...
              <div className="mb-6">
                ...
                <textarea
                  ...
                  rows={12}
                  className="w-full px-4 py-3 border border-blue-200 rounded-xl focus:ring-2 focus:ring-[#FDD14E] focus:border-transparent transition-all duration-200 bg-blue-50/50 resize-vertical"
                />
              ...
              <div className="flex gap-4">
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#FDD14E] to-[#FDD14E] text-white rounded-xl font-medium hover:from-blue-600 hover:to-blue-500 transition-all duration-200 disabled:opacity-50"
                >
                  <Save size={18} />
            ...
            <div className="p-8">
              <div className="flex items-center justify-between mb-6">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-[#FDD14E] to-[#FDD14E] text-white rounded-xl font-medium hover:from-blue-600 hover:to-blue-500 transition-all duration-200"
                >
              ...
              {data[activeTab]?.content ? (
                <div className="bg-blue-50 rounded-xl p-6 border border-blue-200">
                  <div className="pblue pblue-blue max-w-none">
